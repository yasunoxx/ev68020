...
SIGNAL  N_44_grpi, N_6_grpi, N_10_grpi, N_2_grpi,
	 N_14_grpi, N_21_grpi, N_16_grpi, N_19_grpi,
	 ...
	 IO12_OBUFI, AND_811_iomux, IO13_OBUFI, AND_810_iomux,
	 IO16_OBUFI, AND_809_iomux, IO14_OBUFI, AND_808_iomux,
	 IO15_OBUFI, AND_807_iomux, IO17_OBUFI, AND_806_iomux,
	 IO18_OBUFI, AND_805_iomux, IO19_OBUFI, AND_804_iomux,
	 IO39_OBUFI, N_59_iomux, IO38_OBUFI, N_55_iomux,
	 IO37_OBUFI, N_49_iomux, IO36_OBUFI, N_47_iomux,
	 N_44, A0_CLK, A0_P8_xa, AND_810,
	 A0_X1O, A0_P13_xa, A0_X0O, A0_G3,
	 A0_G2, R_WX_grp, A0_P13, A0_IN0,
	 N_44_ffb, A0_P8, A0_IN8, A0_IN16B,
	 A3_P0_xa, AND_807, A3_X3O, A3_P4_xa,
	 AND_808, A3_X2O, A3_P13_xa, AND_811,
	 A3_X0O, A3_G3, A3_G1, A3_G0,
	 A3_P13, A3_IN4, A3_P4, A3_IN10,
	 A3_P0, A3_IN0B, A3_IN9, N_21,
	 A6_CLK, A6_P8_xa, A6_X1O, A6_P13_xa,
	 AND_809, A6_X0O, A6_G3, A6_G2,
	 A6_P13, A6_IN0B, A6_IN6, A6_P8,
	 A6_IN1, A7_P0_xa, AND_804, A7_X3O,
	 A7_P4_xa, AND_805, A7_X2O, A7_P8_xa,
	 AND_806, A7_X1O, A7_G2, A7_G1,
	 A7_G0, A7_P8, A7_IN5, A7_P4,
	 A7_IN0B, A7_P0, A7_IN0, A7_IN2B,
	 N_47, B1_CLK, B1_P13_xa, B1_X0O,
	 B1_G3, B1_F0, B1_P13, B1_P3,
	 B1_IN1, B1_IN2, B1_IN3, N_59,
	 N_55, N_49, B2_CLK, B2_X2O,
	 B2_P8_xa, B2_X1O, B2_G2, B2_G1,
	 B2_F5, B2_F1, B2_F0, B2_P18,
	 B2_P17, B2_P16, WAIT2X_grp, B2_P15,
	 B2_IN9B, B2_P14, INV_SEL_CX_grp, INV_SEL_0X_grp,
	 B2_P13, B2_IN10, B2_IN11, B2_P8,
	 B2_P7, WAIT1X_grp, B2_P3, B2_IN8B,
	 INV_SEL_8TOBX_grp, INV_SEL_4TO7X_grp, INV_SEL_1X_grp, B2_P2,
	 B2_IN0, B2_IN5, B2_IN6, INV_FC0X_grp,
	 INV_FC1X_grp, INV_FC2X_grp, INV_SEL_FX_grp, B2_P1,
	 B2_IN1, B2_IN2, B2_IN3, B2_IN7B,
	 INV_ASX_dir, B2_P0, B2_IN16, N_16,
	 N_19, N_2, B5_CLK, B5_P4_xa,
	 B5_X2O, B5_P8_xa, B5_X1O, B5_P13_xa,
	 B5_X0O, B5_G3, B5_G2, B5_G1,
	 B5_F0, B5_P13, B5_IN8B, B5_P8,
	 B5_P4, B5_IN14B, B5_P3, B5_IN14,
	 B5_P2, B5_IN9B, B5_IN12, B5_IN13B,
	 N_10, N_14, N_6, L2L_KEYWD_RESET_glbb,
	 C7_CLK, PLDCLKX_clk0, C7_F3, C7_F2,
	 C7_F1, C7_P16, C7_P15, C7_P14,
	 C7_P11, C7_P10, C7_P9, C7_P8,
	 C7_P7, C7_IN8, C7_IN9B, A0X_grp,
	 C7_P6, C7_IN9, C7_P5, C7_IN12,
	 C7_IN13, INV_DSX_grp, SIZ1X_grp, SIZ0X_grp,
	 A1X_grp, C7_P4, C7_IN8B, C7_IN12B,
	 C7_IN13B, C7_IN14B : std_logic;
...
GLB_A0_P13 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => A0_P13, A0 => A0_IN0);
GLB_A0_P8 : PGAND2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => A0_P8, A1 => A0_IN8, A0 => A0_IN16B);
GLB_A0_G3 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => A0_G3, A0 => GND);
GLB_A0_G2 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => A0_G2, A0 => GND);
GLB_A0_CLK : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => A0_CLK, A0 => PLDCLKX_clk0);
GLB_A0_P8_xa : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 3.300000 ns, TFALL => 3.300000 ns)
	PORT MAP (Z0 => A0_P8_xa, A0 => A0_P8);
GLB_AND_810 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => AND_810, A0 => A0_X1O);
GLB_A0_P13_xa : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 3.300000 ns, TFALL => 3.300000 ns)
	PORT MAP (Z0 => A0_P13_xa, A0 => A0_P13);
GLB_A0_IN0 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => A0_IN0, A0 => R_WX_grp);
GLB_A0_IN8 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => A0_IN8, A0 => N_6_grpi);
GLB_A0_X1O : PGXOR2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
...
GLB_N_44 : PGDFFR_ARBITER_TOP
    GENERIC MAP (HLCQ => 0.300000 ns, LHCQ => 0.300000 ns, HLRQ => 1.300000 ns, SUD0 => 1.200000 ns, 
        ...
        HOLDRC => 0.000000 ns)
	PORT MAP (Q0 => N_44, RNESET => L2L_KEYWD_RESET_glbb, CD => GND, CLK => A0_CLK, 
	D0 => A0_X0O);
GLB_A0_IN16B : PGINVI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (ZN0 => A0_IN16B, A0 => N_44_ffb);
GLB_A3_P13 : PGAND2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => A3_P13, A1 => A3_IN0B, A0 => A3_IN4);
GLB_A3_P4 : PGAND2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => A3_P4, A1 => A3_IN0B, A0 => A3_IN10);
GLB_A3_P0 : PGAND2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => A3_P0, A1 => A3_IN0B, A0 => A3_IN9);
...
GLB_A3_G0 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => A3_G0, A0 => GND);
GLB_A3_P0_xa : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 3.300000 ns, TFALL => 3.300000 ns)
	PORT MAP (Z0 => A3_P0_xa, A0 => A3_P0);
GLB_AND_807 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => AND_807, A0 => A3_X3O);
GLB_A3_P4_xa : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 3.300000 ns, TFALL => 3.300000 ns)
	PORT MAP (Z0 => A3_P4_xa, A0 => A3_P4);
GLB_AND_808 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => AND_808, A0 => A3_X2O);
GLB_A3_P13_xa : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 3.300000 ns, TFALL => 3.300000 ns)
	PORT MAP (Z0 => A3_P13_xa, A0 => A3_P13);
GLB_AND_811 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => AND_811, A0 => A3_X0O);
GLB_A3_IN4 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => A3_IN4, A0 => N_2_grpi);
GLB_A3_IN10 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => A3_IN10, A0 => N_10_grpi);
GLB_A3_IN9 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => A3_IN9, A0 => N_14_grpi);
GLB_A3_X3O : PGXOR2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
...
GLB_A3_IN0B : PGINVI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (ZN0 => A3_IN0B, A0 => N_44_grpi);
GLB_A6_P13 : PGAND2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => A6_P13, A1 => A6_IN0B, A0 => A6_IN6);
GLB_A6_P8 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => A6_P8, A0 => A6_IN1);
...
GLB_AND_809 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => AND_809, A0 => A6_X0O);
GLB_A6_IN6 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => A6_IN6, A0 => N_16_grpi);
GLB_A6_IN1 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => A6_IN1, A0 => INV_DSX_grp);
...
GLB_N_21 : PGDFFR_ARBITER_TOP
    GENERIC MAP (HLCQ => 0.300000 ns, LHCQ => 0.300000 ns, HLRQ => 1.300000 ns, SUD0 => 1.200000 ns, 
        ...
        POSC0 => 5.000000 ns, NEGC1 => 5.000000 ns, NEGC0 => 5.000000 ns, RECRC => 0.000000 ns, 
        HOLDRC => 0.000000 ns)
	PORT MAP (Q0 => N_21, RNESET => L2L_KEYWD_RESET_glbb, CD => GND, CLK => A6_CLK, 
	D0 => A6_X1O);
GLB_A6_IN0B : PGINVI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (ZN0 => A6_IN0B, A0 => N_44_grpi);
GLB_A7_P8 : PGAND2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => A7_P8, A1 => A7_IN0B, A0 => A7_IN5);
GLB_A7_P4 : PGAND2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => A7_P4, A1 => A7_IN0B, A0 => A7_IN2B);
GLB_A7_P0 : PGAND2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => A7_P0, A1 => A7_IN0, A0 => A7_IN2B);
GLB_A7_G2 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => A7_G2, A0 => GND);
GLB_A7_G1 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => A7_G1, A0 => GND);
GLB_A7_G0 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => A7_G0, A0 => GND);
GLB_A7_P0_xa : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 3.300000 ns, TFALL => 3.300000 ns)
	PORT MAP (Z0 => A7_P0_xa, A0 => A7_P0);
GLB_AND_804 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => AND_804, A0 => A7_X3O);
GLB_A7_P4_xa : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 3.300000 ns, TFALL => 3.300000 ns)
	PORT MAP (Z0 => A7_P4_xa, A0 => A7_P4);
GLB_AND_805 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => AND_805, A0 => A7_X2O);
GLB_A7_P8_xa : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 3.300000 ns, TFALL => 3.300000 ns)
	PORT MAP (Z0 => A7_P8_xa, A0 => A7_P8);
GLB_AND_806 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => AND_806, A0 => A7_X1O);
GLB_A7_IN5 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => A7_IN5, A0 => N_19_grpi);
GLB_A7_IN0 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => A7_IN0, A0 => N_44_grpi);
GLB_A7_X3O : PGXOR2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => A7_X3O, A1 => A7_P0_xa, A0 => A7_G0);
GLB_A7_X2O : PGXOR2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => A7_X2O, A1 => A7_P4_xa, A0 => A7_G1);
GLB_A7_X1O : PGXOR2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => A7_X1O, A1 => A7_P8_xa, A0 => A7_G2);
GLB_A7_IN0B : PGINVI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (ZN0 => A7_IN0B, A0 => N_44_grpi);
GLB_A7_IN2B : PGINVI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (ZN0 => A7_IN2B, A0 => N_21_grpi);
...
GLB_B2_P7 : PGAND4_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => B2_P7, A3 => B2_IN1, A2 => B2_IN2, A1 => B2_IN3, 
	A0 => B2_IN7B);
GLB_B2_P3 : PGAND2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => B2_P3, A1 => B2_IN0, A0 => B2_IN8B);
GLB_B2_P2 : PGAND3_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => B2_P2, A2 => B2_IN0, A1 => B2_IN5, A0 => B2_IN6);
GLB_B2_P1 : PGAND4_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => B2_P1, A3 => B2_IN1, A2 => B2_IN2, A1 => B2_IN3, 
	A0 => B2_IN7B);
GLB_B2_P0 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => B2_P0, A0 => B2_IN16);
...
GLB_B5_P13 : PGAND3_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => B5_P13, A2 => B5_IN8B, A1 => B5_IN9B, A0 => B5_IN14B);
GLB_B5_P8 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => B5_P8, A0 => VCC);
GLB_B5_P4 : PGAND2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => B5_P4, A1 => B5_IN9B, A0 => B5_IN14B);
GLB_B5_P3 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => B5_P3, A0 => B5_IN14);
GLB_B5_P2 : PGAND3_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => B5_P2, A2 => B5_IN9B, A1 => B5_IN12, A0 => B5_IN13B);
GLB_B5_G3 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => B5_G3, A0 => GND);
GLB_B5_G2 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => B5_G2, A0 => B5_F0);
GLB_B5_G1 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => B5_G1, A0 => GND);
GLB_B5_F0 : PGORF72_ARBITER_TOP
    GENERIC MAP (TRISE => 2.500000 ns, TFALL => 2.500000 ns)
	PORT MAP (Z0 => B5_F0, A1 => B5_P2, A0 => B5_P3);
GLB_B5_CLK : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => B5_CLK, A0 => PLDCLKX_clk0);
GLB_B5_P4_xa : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 3.300000 ns, TFALL => 3.300000 ns)
	PORT MAP (Z0 => B5_P4_xa, A0 => B5_P4);
...
GLB_B5_IN14 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => B5_IN14, A0 => INV_DSX_grp);
GLB_B5_IN12 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => B5_IN12, A0 => SIZ0X_grp);
GLB_B5_X2O : PGXOR2_ARBITER_TOP
    GENERIC MAP (TRISE => 1.300000 ns, TFALL => 1.300000 ns)
	PORT MAP (Z0 => B5_X2O, A1 => B5_P4_xa, A0 => B5_G1);
...
GLB_N_19 : PGDFFR_ARBITER_TOP
    GENERIC MAP (HLCQ => 0.300000 ns, LHCQ => 0.300000 ns, HLRQ => 1.300000 ns, SUD0 => 1.200000 ns, 
        ...
        POSC0 => 5.000000 ns, NEGC1 => 5.000000 ns, NEGC0 => 5.000000 ns, RECRC => 0.000000 ns, 
        HOLDRC => 0.000000 ns)
	PORT MAP (Q0 => N_19, RNESET => L2L_KEYWD_RESET_glbb, CD => GND, CLK => B5_CLK, 
	D0 => B5_X1O);
GLB_N_2 : PGDFFR_ARBITER_TOP
    GENERIC MAP (HLCQ => 0.300000 ns, LHCQ => 0.300000 ns, HLRQ => 1.300000 ns, SUD0 => 1.200000 ns, 
        ...
        POSC0 => 5.000000 ns, NEGC1 => 5.000000 ns, NEGC0 => 5.000000 ns, RECRC => 0.000000 ns, 
        HOLDRC => 0.000000 ns)
	PORT MAP (Q0 => N_2, RNESET => L2L_KEYWD_RESET_glbb, CD => GND, CLK => B5_CLK, 
	D0 => B5_X0O);
...
GLB_C7_P16 : PGAND3_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => C7_P16, A2 => C7_IN8B, A1 => C7_IN9, A0 => C7_IN14B);
GLB_C7_P15 : PGAND3_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => C7_P15, A2 => C7_IN8B, A1 => C7_IN13, A0 => C7_IN14B);
GLB_C7_P14 : PGAND3_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => C7_P14, A2 => C7_IN8B, A1 => C7_IN12B, A0 => C7_IN14B);
GLB_C7_P11 : PGAND3_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => C7_P11, A2 => C7_IN8, A1 => C7_IN9, A0 => C7_IN14B);
GLB_C7_P10 : PGAND3_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => C7_P10, A2 => C7_IN8, A1 => C7_IN13, A0 => C7_IN14B);
GLB_C7_P9 : PGAND3_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => C7_P9, A2 => C7_IN12B, A1 => C7_IN13B, A0 => C7_IN14B);
GLB_C7_P8 : PGAND4_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => C7_P8, A3 => C7_IN9, A2 => C7_IN12, A1 => C7_IN13, 
	A0 => C7_IN14B);
GLB_C7_P7 : PGAND3_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => C7_P7, A2 => C7_IN8, A1 => C7_IN9B, A0 => C7_IN14B);
GLB_C7_P6 : PGAND4_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => C7_P6, A3 => C7_IN8B, A2 => C7_IN9, A1 => C7_IN12B, 
	A0 => C7_IN14B);
GLB_C7_P5 : PGAND4_ARBITER_TOP
    GENERIC MAP (TRISE => 1.400000 ns, TFALL => 1.400000 ns)
	PORT MAP (Z0 => C7_P5, A3 => C7_IN8B, A2 => C7_IN12, A1 => C7_IN13, 
	A0 => C7_IN14B);
GLB_C7_P4 : PGAND4_ARBITER_TOP
    GENERIC MAP (TRISE => 1.700000 ns, TFALL => 1.700000 ns)
	PORT MAP (Z0 => C7_P4, A3 => C7_IN8B, A2 => C7_IN12B, A1 => C7_IN13B, 
	A0 => C7_IN14B);
GLB_C7_F3 : PGORF73_ARBITER_TOP
    GENERIC MAP (TRISE => 3.600000 ns, TFALL => 3.600000 ns)
	PORT MAP (Z0 => C7_F3, A2 => C7_P14, A1 => C7_P15, A0 => C7_P16);
GLB_C7_F2 : PGORF74_ARBITER_TOP
    GENERIC MAP (TRISE => 3.600000 ns, TFALL => 3.600000 ns)
	PORT MAP (Z0 => C7_F2, A3 => C7_P8, A2 => C7_P9, A1 => C7_P10, 
	A0 => C7_P11);
GLB_C7_F1 : PGORF74_ARBITER_TOP
    GENERIC MAP (TRISE => 3.600000 ns, TFALL => 3.600000 ns)
	PORT MAP (Z0 => C7_F1, A3 => C7_P4, A2 => C7_P5, A1 => C7_P6, 
	A0 => C7_P7);
GLB_C7_CLK : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => C7_CLK, A0 => PLDCLKX_clk0);
GLB_C7_IN8 : PGBUFI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (Z0 => C7_IN8, A0 => A1X_grp);
...
GLB_N_10 : PGDFFR_ARBITER_TOP
    GENERIC MAP (HLCQ => 0.300000 ns, LHCQ => 0.300000 ns, HLRQ => 1.300000 ns, SUD0 => 1.200000 ns, 
        ...
        POSC0 => 5.000000 ns, NEGC1 => 5.000000 ns, NEGC0 => 5.000000 ns, RECRC => 0.000000 ns, 
        HOLDRC => 0.000000 ns)
	PORT MAP (Q0 => N_10, RNESET => L2L_KEYWD_RESET_glbb, CD => GND, CLK => C7_CLK, 
	D0 => C7_F1);
GLB_N_14 : PGDFFR_ARBITER_TOP
    GENERIC MAP (HLCQ => 0.300000 ns, LHCQ => 0.300000 ns, HLRQ => 1.300000 ns, SUD0 => 1.200000 ns, 
        ...
        POSC0 => 5.000000 ns, NEGC1 => 5.000000 ns, NEGC0 => 5.000000 ns, RECRC => 0.000000 ns, 
        HOLDRC => 0.000000 ns)
	PORT MAP (Q0 => N_14, RNESET => L2L_KEYWD_RESET_glbb, CD => GND, CLK => C7_CLK, 
	D0 => C7_F2);
GLB_N_6 : PGDFFR_ARBITER_TOP
    GENERIC MAP (HLCQ => 0.300000 ns, LHCQ => 0.300000 ns, HLRQ => 1.300000 ns, SUD0 => 1.200000 ns, 
        ...
        POSC0 => 5.000000 ns, NEGC1 => 5.000000 ns, NEGC0 => 5.000000 ns, RECRC => 0.000000 ns, 
        HOLDRC => 0.000000 ns)
	PORT MAP (Q0 => N_6, RNESET => L2L_KEYWD_RESET_glbb, CD => GND, CLK => C7_CLK, 
	D0 => C7_F3);
GLB_C7_IN9B : PGINVI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (ZN0 => C7_IN9B, A0 => A0X_grp);
GLB_C7_IN14B : PGINVI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (ZN0 => C7_IN14B, A0 => INV_DSX_grp);
...
GLB_C7_IN8B : PGINVI_ARBITER_TOP
    GENERIC MAP (TRISE => 0.500000 ns, TFALL => 0.500000 ns)
	PORT MAP (ZN0 => C7_IN8B, A0 => A1X_grp);
...
GRP_N_44_ffb : PGBUFI_ARBITER_TOP
