--
-- Synopsys
-- Vhdl wrapper for top level design, written on Mon Jan 13 19:48:12 2025
--
library ieee;
...
signal tmp_INV_WAIT2 : std_logic;
signal tmp_INV_WAIT1 : std_logic;
...
tmp_INV_WAIT2 <= INV_WAIT2;

tmp_INV_WAIT1 <= INV_WAIT1;
...
u1:   ARBITER_TOP port map (
		...
		R_W => tmp_R_W,
		INV_RD => tmp_INV_RD,
		INV_WAIT2 => tmp_INV_WAIT2,
		INV_WAIT1 => tmp_INV_WAIT1
       );
end schematic;
